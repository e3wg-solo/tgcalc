...
import { Wallet, ArrowRightLeft, Coins, CheckCircle2, Circle, TrendingUp } from 'lucide-react'
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span
                  className={`text-sm font-medium px-2 py-0.5 rounded ${
                    summary?.totalProfit >= 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'
                  }`}
                >
                  Чистая прибыль
                </span>
            ...
            <div className="flex gap-6 text-sm items-center">
              <div className="text-right">
                ...
                <div
                  className="font-bold text-lg text-amber-600 border-b border-dashed border-amber-300 inline-block"
              ...
              <div className="text-right border-l pl-6 border-slate-100">
                ...
                <div
                  className={`font-bold text-lg ${
                    summary?.margin >= 0 ? 'text-emerald-600' : 'text-red-500'
                  }`}
                >
            ...
            <div className="flex bg-slate-100 p-1 rounded-lg">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                  calcMode === 'stars' ? 'bg-white shadow text-slate-800' : 'text-slate-500 hover:text-slate-700'
                }`}
              >
                В Звездах (шт)
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                  calcMode === 'ton' ? 'bg-white shadow text-slate-800' : 'text-slate-500 hover:text-slate-700'
                }`}
              >
                Бюджет (TON)
              </button>
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                      ...
                      <input
                        ...
                        className={`w-full p-2 border rounded-lg font-mono text-sm focus:ring-2 focus:ring-indigo-500 outline-none ${
